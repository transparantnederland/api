...
exports.orgsFromOrg = function (query, callback) {
  var results;
  var relations = ['tnl:parent'];
  ...
  function getOrgsFromOrg(cb) {
    graph.orgsFromOrg(normalizeUri(query.id).normalized, relations, cb);
  }
