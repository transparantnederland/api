...
exports.peopleFromOrg = function(id, relations, callback) {
  ...
  graphDb.cypher({
    ...
    callback(err, { "ids": ids, "types": types } );
  });
};
...
exports.peopleFromOrgsFromPerson = function(id, relations, organizations, callback) {
  var query = replaceOrganizations(replaceRelations(peopleFromOrgsFromPersonQuery, relations), organizations);
  graphDb.cypher({
    query: query,
    params: {
      id: id
...
//   for (var concept in body) {
//     for (var pit in concept) {
//       pit.delete("hairs")
//     }
//   }
